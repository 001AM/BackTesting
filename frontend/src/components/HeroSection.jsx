    ...
    <section className="py-20">
      <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            A comprehensive platform for testing fundamental analysis strategies on Indian equities. Configure custom
            filters, ranking systems, and position sizing methods to validate your investment approach.
          </p>
